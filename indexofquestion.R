...
continent <- cbind(rbind("Not in result","Continent"),rbind("Not in result","Continent"),rbind("Not in result","Continent"),rbind("Not in result","Continent"))

ncol(indexofquestion)
indexofquestion <- cbind(indexofquestion[,1:84], continent,indexofquestion[,85:351])
indexofquestion <- cbind(indexofquestion,rbind("Not in result",name[356]))
indexofquestion <- cbind(indexofquestion,rbind("Not in result",name[357]))
indexofquestion[2,145] <- "V28"
indexofquestion[2,146] <- "V29"
